...
def parse_args():
    ...
    parser.add_argument("--dataset", type=str, default="Qilin_v2")

    parser.add_argument("--src_emb", type=str, default="")
    parser.add_argument("--rec_emb", type=str, default="")

    parser.add_argument('--e_dim',
                        type=int,
                        default=32,
                        help='vq codebook embedding size')

    parser.add_argument('--src_num_emb_list',
                        type=int,
                        nargs='+',
                        default=[],
                        help='emb num of every vq')

    parser.add_argument('--rec_num_emb_list',
                        type=int,
                        nargs='+',
                        default=[],
                        help='emb num of every vq')

    parser.add_argument('--sk_epsilons',
                        type=float,
                        nargs='+',
